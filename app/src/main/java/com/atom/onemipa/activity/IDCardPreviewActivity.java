...
import com.atom.onemipa.models.DBModel;
import com.atom.onemipa.scrapbook.ImageStickerConfig;
import com.atom.onemipa.scrapbook.LocalDisplay;
import com.atom.onemipa.scrapbook.StickerConfigInterface;
import com.atom.onemipa.scrapbook.StickerHolderView;
import com.atom.onemipa.scrapbook.TextStickerConfig;
    ...
    private class saveIDCard extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        public Bitmap doInBackground(Bitmap... bitmapArr) {
            ...
            if (Constant.inputType.equals("Group")) {
                group_name = "Scanner" + Constant.getDateTime("_ddMMHHmmss");
